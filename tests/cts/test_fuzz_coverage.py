...
FUZZ_REQUIRED = {
    ...
    "check_failure_only_diagnostics": "check_file",
    ...
    "check_unreferenced_local_uses": "check_repo",
    ...
    "check_cwd_scoped_git": "violations",
    "check_dead_shell_functions": "find_dead",
    "check_duplicate_class_names": "top_level_classes",
    "check_duplicate_module_constant": "violations",
    "check_env_arith": "violations",
    "check_path_shadowed_interpreter": "violations",
    "check_positional_git_argv": "violations",
    "check_relative_imports": "violations",
    "check_retry_loop": "violations",
