...
| `check-required-reporter`          | A new reporter is green but nobody added it to branch protection, so it gates nothing. Reads the `# required-check:` markers.                                                                                                                                                                   | a reporter with no `# required-check:` marker                           |
